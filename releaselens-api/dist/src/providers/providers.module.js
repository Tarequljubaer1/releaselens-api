...
const gitlab_provider_1 = require("./gitlab.provider");
...
exports.ProvidersModule = ProvidersModule = __decorate([
    (0, common_1.Module)({
        providers: [github_provider_1.GithubProvider, gitlab_provider_1.GitlabProvider],
        exports: [github_provider_1.GithubProvider, gitlab_provider_1.GitlabProvider],
    })
], ProvidersModule);
